...
function Humanoid(humanoidProp){
  CharacterStats.call (this, humanoidProp);
  this.team = humanoidProp.team;
  this.weapons = humanoidProp.weapons;
  this.language = humanoidProp.language;
}
